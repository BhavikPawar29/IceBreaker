...
const contextByContainer = new WeakMap();
...
function Grainient({
  ...
  useEffect(() => {
    ...
    contextByContainer.set(container, { mesh, program, renderer });
  ...
  useEffect(() => {
    const container = containerRef.current;
    const context = container ? contextByContainer.get(container) : null;
