...
const CreatePage = lazy(
  () => import("../features/create/components/CreatePage"),
);
const LandingPage = lazy(
  () => import("../features/landing/components/LandingPage"),
);
const LineDetailPage = lazy(
  () => import("../features/profile/components/LineDetailPage"),
);
const LoginPage = lazy(() => import("../features/auth/components/LoginPage"));
const LivePage = lazy(() => import("../features/live/components/LivePage"));
...
const PrivacyPage = lazy(
  () => import("../features/legal/components/PrivacyPage"),
);
const SecurityPage = lazy(
  () => import("../features/legal/components/SecurityPage"),
);
